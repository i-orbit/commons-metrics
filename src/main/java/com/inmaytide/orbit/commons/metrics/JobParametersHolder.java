 ...
 * @since 2023/8/3
 */
public class JobParametersHolder {

    private static final long CACHE_VALID_TIME_IN_SECONDS = 30 * 60;

    private static final Logger LOG = LoggerFactory.getLogger(JobParametersHolder.class);
    ...
    public static JobParameter get(String name) {
    ...
    private static @NonNull JobParameter load(String name) {
